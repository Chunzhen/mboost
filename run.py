...
def level_one_wrapper():
	...
	X_0,X_1,uid_0,uid_1=load_data_instance.part_uid_xy(level,'log_move_lr_sag22')#log_move_lr_sag22_part_uid

	threads=[]
	#threads.append(Level_train_thread(config_instance,LogisticRegression(solver='sag'),level,ftype+'_lr_sag22',X_0,X_1,uid_0,uid_1))
	...
	#threads.append(Level_train_thread(config_instance,RandomForestClassifier(n_estimators=100,max_depth=8,min_samples_split=9),level,ftype+'_rf100_22',X_0,X_1,uid_0,uid_1))
	...
	# for i in range(100):
	# 	config_instance=Config(ftype)
	# 	config_instance.fold_random_state=i
	#threads.append(Xgb_level_train_thread(config_instance,level,ftype+'_xgb1000_test_iii',X_0,X_1,uid_0,uid_1,params,2500))
...
def level_two_wrapper():
	...
	threads=[]
	#ftype='log_move_random_7'
	#config_instance.fold_random_state=7
	# for i in range(10):
	# 	config_instance.fold_random_state=i
	# 	threads.append(Level_train_thread(config_instance,RandomForestClassifier(n_estimators=100,max_depth=2,min_samples_split=10),level,ftype+'_rf100_22',X_0,X_1,uid_0,uid_1))

	# rbm=BernoulliRBM(random_state=1,verbose=True)
	# rbm_classifier=Pipeline(steps=[('rbm',rbm),('logistic',LogisticRegression(solver='sag'))])
	# rbm.learning_rate=0.01
	# rbm.n_iter=1
	# rbm.n_components=100
	# threads.append(Level_train_thread(config_instance,rbm_classifier,level,ftype+'_rbm',X_0,X_1,uid_0,uid_1))
...
def level_two_predict():
	...
	threads=[]
	threads.append(Level_predict_thread(config_instance,LogisticRegression(solver='sag'),level,'log_move_lr_sag2',X_0,X_1,predict_X,predict_uid))
